...
async function downloadWebHtml() {
  ...
  const styleMap = {
    ...
    '.source-list-links a': 'text-decoration: none !important;',
    '.source-link-item': 'display: flex; align-items: center; padding: 10px 14px; background: rgba(0, 45, 84, 0.03); border-radius: 10px; text-decoration: none !important; color: #1f2937; border: 1px solid rgba(0, 45, 84, 0.05);',
    '.source-icon': 'font-size: 16px; margin-right: 12px;',
