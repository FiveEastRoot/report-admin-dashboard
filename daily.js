...
async function downloadWebHtml() {
  ...
  const styleMap = {
    ...
    '.card-thumb': 'width: 180px; flex-shrink: 0; background-color: #F1F5F9;',
  ...
  // 4. Final Cleanup: remove classes to reduce board logic dependency (optional but requested)
  // Actually keeping classes is fine as long as style="" is there.
  
  // 5. Hide elements that are still hidden in the preview
